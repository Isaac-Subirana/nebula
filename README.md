...
You can find the documentation **_in English_** detailing how to obtain Chromium's code and modify and compile it to get Nebula [here](https://github.com/Isaac-Subirana/nebula/blob/main/README_ENGLISH.md).
...
Pot trobar la documentació **_en català_** sobre com descarregar-se, modificar i compilar el codi de Chromium per obtenir el navegador Nebula [des d'aquí](https://github.com/Isaac-Subirana/nebula/blob/main/README_CATAL%C3%80.md). 
  
Pot descarregar-se Nebula des d'[aquí](https://github.com/Isaac-Subirana/nebula/releases) (`Nebula-Setup.exe`).
...
Puede encontrar la documentación **_en español_** sobre cómo descargar, modificar y compilar el código de Chromium para obtener el navegador Nebula [aquí](https://github.com/Isaac-Subirana/nebula/blob/main/README_ESPA%C3%91OL.md).

Puede descargarse Nebula [aquí](https://github.com/Isaac-Subirana/nebula/releases) (`Nebula-Setup.exe`).
